...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
  //vector<int> current_node.neighbors = FindNeighbors(RouteModel::Node *current_node);
...
//RoutePlanner::RouteModel::Node *NextNode(){
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
  ...
  std::vector<RouteModel::Node> path_found;
    ...
    // to convert distance to the scale of the map using the MetricScale() method
